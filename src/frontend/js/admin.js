...
let applicationsDataCache = null;
...
async function loadApplications(forceRefresh = false) {
  ...
  try {
    ...
    applicationsDataCache = data;

    // Filter by show processed checkbox
    ...
    if (applicationsTable) {
      ...
      applicationsTable = new Tabulator("#applicationsTable", {
        data: filteredData,
        layout: "fitDataFill",
        pagination: true,
        paginationSize: 30,
...
async function createEventFromApplication(applicationId) {
...
async function createEventFromApplicationDirect(applicationId) {
...
async function rejectApplication(applicationId) {
  ...
  try {
    ...
    showToast("Failed to reject application: " + error.message, "error", 5000);
  }
}
...
// Applications tab event listeners
document
...
// Application modal event listeners
document.getElementById("closeApplicationModal").addEventListener("click", () => {
  document.getElementById("applicationModal").classList.remove("show");
});

document.getElementById("closeApplicationModalBtn").addEventListener("click", () => {
  document.getElementById("applicationModal").classList.remove("show");
});

document.getElementById("createEventFromApplication").addEventListener("click", () => {
