...
小さい顔（遠くに写っている人）の笑顔スコアには係数をかけて調整します：
...
**目的**: 近くで大きく写っている顔をより重視しつつ、遠景の顔も完全には無視しない
...
> **重要**: 類似判定は**同一ユーザー内のみ**で行われます。他のユーザーが投稿した画像とは比較しません。これにより、異なるユーザーが同じ場面で撮った写真が不当にペナルティを受けることを防ぎます。
